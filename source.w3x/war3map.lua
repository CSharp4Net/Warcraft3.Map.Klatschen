...
function CreateBuildingsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("hhou"), -9280.0, 13376.0, 270.000, FourCC("hhou"))
...
function CreateBuildingsForPlayer4()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h00V"), 9728.0, 13824.0, 270.000, FourCC("h00V"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00V"), 10752.0, 12800.0, 270.000, FourCC("h00V"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00V"), 6912.0, 13312.0, 270.000, FourCC("h00V"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00W"), 10752.0, 13312.0, 270.000, FourCC("h00W"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h00X"), 10240.0, 13824.0, 270.000, FourCC("h00X"))
    u = BlzCreateUnitWithSkin(p, FourCC("n005"), 11264.0, 14336.0, 270.000, FourCC("n005"))
...
function CreateBuildingsForPlayer5()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h017"), 11776.0, 11264.0, 270.000, FourCC("h017"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00D"), 7168.0, 14848.0, 270.000, FourCC("h00D"))
end
...
function CreateBuildingsForPlayer6()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h017"), 11776.0, 10752.0, 270.000, FourCC("h017"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00D"), 7680.0, 14848.0, 270.000, FourCC("h00D"))
end
...
function CreateBuildingsForPlayer7()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h017"), 11776.0, 10240.0, 270.000, FourCC("h017"))
    u = BlzCreateUnitWithSkin(p, FourCC("h00D"), 8192.0, 14848.0, 270.000, FourCC("h00D"))
end
...
function CreateBuildingsForPlayer8()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -9728.0, -7680.0, 270.000, FourCC("h011"))
    u = BlzCreateUnitWithSkin(p, FourCC("h011"), -10752.0, -6656.0, 270.000, FourCC("h011"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h013"), -10240.0, -7680.0, 270.000, FourCC("h013"))
    u = BlzCreateUnitWithSkin(p, FourCC("h012"), -10752.0, -7168.0, 270.000, FourCC("h012"))
...
function CreateBuildingsForPlayer9()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h016"), -11776.0, -5120.0, 270.000, FourCC("h016"))
...
function CreateBuildingsForPlayer10()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h016"), -11776.0, -4608.0, 270.000, FourCC("h016"))
...
function CreateBuildingsForPlayer11()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("h016"), -11776.0, -4096.0, 270.000, FourCC("h016"))
...
function CreateBuildingsForPlayer12()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h01C"), 10240.0, -7680.0, 270.000, FourCC("h01C"))
    u = BlzCreateUnitWithSkin(p, FourCC("n005"), 11264.0, -8192.0, 270.000, FourCC("n005"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("h019"), 9728.0, -7680.0, 270.000, FourCC("h019"))
    u = BlzCreateUnitWithSkin(p, FourCC("h019"), 10752.0, -6656.0, 270.000, FourCC("h019"))
    u = BlzCreateUnitWithSkin(p, FourCC("h01D"), 10752.0, -7168.0, 270.000, FourCC("h01D"))
